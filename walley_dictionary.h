    ...
    for(i=0;i<count_of_douhao;i++){
       ...
       // printf("TEMP IS %s\n",temp);
        if(find_not_in_string(dictionary,temp)!=-1){
           ...
           // printf("last key %s, begin_of_left %d\n",last_key,begin_of_left);
           ...
           // printf("begin_of_left %d, end_of_last_right %d\n",begin_of_left,end_of_last_right);
